...
| Serde              | `synthesis/serde_synth.rs`     | Struct `Deserialize` plus its `FieldSchema` lookup, for bound-driven requests (below; body-less markers record there too). Every other body is a `Reflect*` blanket in `core:serde`, not synthesis                                                                                                                                                                                              |
