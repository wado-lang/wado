<!-- Auto-generated by: wado doc --format markdown --title "WASI Standard Library" wasi:cli wasi:filesystem wasi:http wasi:clocks wasi:random wasi:sockets wasi:tls -->
