...
6. Parse the newly materialized `.wado` files and complete resolution of any deferred `use ... with { generator: { ... } }` statements. Proceed with name resolution, type checking, and the rest of the normal compile.
