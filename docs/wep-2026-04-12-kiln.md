...
- **`#![generated]` module attribute** — already parsed by the compiler (see `wado-compiler/src/ast.rs`). It marks a module as machine-generated. Kiln emits this attribute on every file it writes.
