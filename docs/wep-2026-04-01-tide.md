...
- [ ] Parse fields on `#[cm]`; today it accepts exactly one string literal (`wado-compiler/src/parser.rs`)
- [ ] Validate the value: `"extern-ref"` | `"i32"`
- [ ] `type="extern-ref"` makes the resource copyable and exempt from the affine analysis of [Resource Ownership](./wep-2026-05-21-resource-ownership.md)
