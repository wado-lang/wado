<!-- Auto-generated by: wado doc --format markdown core:zlib -->
...
### `pub fn zlib_compress(input: &ByteList, level: i32 = Z_DEFAULT_COMPRESSION, strategy: i32 = Z_DEFAULT_STRATEGY) -> ByteList`
...
### `pub fn inflate_sync_find(input: &ByteList, start: i32) -> i32`
...
#### `pub fn set_extra(&mut self, extra: &ByteList)`
...
#### `pub fn update(&mut self, chunk: &ByteList)`

Appends `chunk` to the input buffer. Panics if the stream has already
been finished.

#### `pub fn finish(&mut self) -> ByteList`
...
#### `pub fn compress(&mut self, input: &ByteList) -> ByteList`
