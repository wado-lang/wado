...
Adaptive LL Engine) and Kiln (Keyed IDL Lowering Notation). Read as elements,
they cover air and fire.

Marl — Markdown Adaptive Rendering Layer. Marl is a calcareous earth (a
mudstone), adding earth to the elemental set, and its spelling echoes
"Markdown".
