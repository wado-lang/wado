...
- **Forward struct field constants** — tracks known field values through `StructGet` for bounds check elimination
...
- **Peephole** — constant folding, copy elision, multi-value struct elision at WIR level
