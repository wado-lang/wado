...
legal suffix start. A suffix carrying a semantic predicate is the one shape
that keeps the plain greedy loop instead: the peek would evaluate the
predicate once per iteration and again on commit.
