...
- [ ] **Recovery trees diverge from ANTLR4 where the edit is Gale's own.** Decision sync and rule-level resync follow ANTLR4 (`resilient-parser.md`, "Recovery"), pinned against the jar in `tests/driver_cst_antlr_recovery_test.wado`. Three places still differ:
