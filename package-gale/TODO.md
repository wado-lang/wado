...
4. Everything else, in whatever order a live case surfaces it. One has surfaced: grammar-import resolution, under "Composite (slave-grammar) descriptors" below.
