...
.PHONY: test-wado
test-wado:
	cargo run -p wado-cli --quiet -- test example/*.wado wado-compiler/lib/core/*_test.wado wado-compiler/lib/core/prelude/*_test.wado benchmark/*/*.wado wasm-size/*/*.wado rsc-fpfmt/*_test.wado
