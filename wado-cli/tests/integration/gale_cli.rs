...
fn gale_gen_calculator_emits_generated_parser() {
    wado()
        ...
        .stdout(predicate::str::contains("pub fn parse<S: AsStrSlice>(input: S"))
        .stdout(predicate::str::contains("pub fn tokenize<S: AsStrSlice>(input: S"));
}
...
fn gale_gen_highlight_emits_highlight_function() {
    ...
    wado()
        ...
        .success()
        .stdout(predicate::str::contains("#![generated(by = \"gale\""))
        .stdout(predicate::str::contains("pub fn highlight<S: AsStrSlice>(input: S"));
}
