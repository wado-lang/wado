(component
  ...
  (core module $main-mod (;1;)
    ...
    (export "run" (func $wado-compiler/tests/format.fixtures/ops.mess_dirty.wado/__cm_export__run))
    (func $wado-compiler/tests/format.fixtures/ops.mess_dirty.wado/__cm_export__run (;2;) (type 2)
      (block ;; label = @1
        (br_if 0 (;@1;)
          (global.get 0)
