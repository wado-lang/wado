(component
  ...
  (core module $main-mod (;1;)
    ...
    (export "run" (func $mess_dirty.wado/__cm_export__run))
    (func $mess_dirty.wado/__cm_export__run (;2;) (type 1)
      (block ;; label = @1
        (br_if 0 (;@1;)
          (global.get 0)
    ...
    (func $core:prelude/fpfmt.wado/__initialize_module (;3;) (type 2))
  )
