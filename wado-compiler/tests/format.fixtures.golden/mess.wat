(component
  ...
  (core module $main-mod (;1;)
    ...
    (type (;2;) (func))
    (type (;3;) (func))
    (type (;4;) (func (param structref i32) (result i32)))
    (type (;5;) (func (param structref i32) (result i32)))
    ...
    (func $__closure_wrapper_0 (;4;) (type 4) (param structref i32) (result i32)
      (unreachable)
      (unreachable)
    )
    (func $__closure_wrapper_1 (;5;) (type 4) (param structref i32) (result i32)
      (unreachable)
      (unreachable)
    )
    (func $__closure_wrapper_2 (;6;) (type 5) (param structref i32) (result i32)
      (unreachable)
      (unreachable)
    )
    (func $__closure_wrapper_3 (;7;) (type 5) (param structref i32) (result i32)
      (unreachable)
      (unreachable)
    )
  )
