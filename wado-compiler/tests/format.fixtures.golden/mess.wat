(component
  ...
  (core module $main-mod (;1;)
    ...
    (func $wado-compiler/tests/format.fixtures/mess.dirty.wado/run (;2;) (type 2))
    (func $wado-compiler/tests/format.fixtures/mess.dirty.wado/__cm_export__run (;3;) (type 3)
      (call 1
        (i32.const 0))
    )
  )
