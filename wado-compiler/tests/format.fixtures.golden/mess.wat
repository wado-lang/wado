(component
  ...
  (core module $main-mod (;1;)
    (rec
      ...
      (type (;1;) (sub (struct (field (mut i64)) (field (mut i64)))))
      (type (;2;) (sub (struct (field (mut i64)) (field (mut i32)))))
      (type (;3;) (sub (struct (field (mut i8)) (field (mut i8)) (field (mut i32)))))
      (type (;4;) (sub (struct (field (mut (ref struct))) (field (mut (ref struct))))))
      (type (;5;) (sub (struct (field (mut (ref struct))) (field (mut (ref struct))))))
      (type (;6;) (sub (struct (field (mut f64)) (field (mut f64)))))
      (type (;7;) (sub (struct)))
      (type (;8;) (sub (struct)))
      (type (;9;) (array (mut i8)))
      (type (;10;) (array (mut i64)))
      (type (;11;) (array (mut i32)))
      (type (;12;) (array (mut structref)))
      (type (;13;) (sub (struct (field (mut (ref 12))) (field (mut i32)))))
      (type (;14;) (sub (struct (field (mut (ref 9))) (field (mut i32)))))
      (type (;15;) (sub (struct (field (mut (ref 10))) (field (mut i32)))))
      (type (;16;) (sub (struct (field (mut (ref 11))) (field (mut i32)))))
      (type (;17;) (array (mut i32)))
      (type (;18;) (sub (struct (field (mut (ref 17))) (field (mut i32)))))
      (type (;19;) (func (param structref i32) (result i32)))
    ...
    (type (;23;) (func))
    (type (;24;) (func))
    (import "mem" "realloc" (func (;0;) (type 21)))
    (import "wasi" "task-return" (func (;1;) (type 22)))
    ...
    (func $__cm_export__run (;3;) (type 24)
      (local (ref null 15))
      (block ;; label = @1
        (if ;; label = @2
          (global.get 0)
    ...
    (func $__closure_wrapper_0 (;4;) (type 19) (param structref i32) (result i32)
      (local (ref null 8))
      (local.set 2
        (ref.cast (ref 8)
          (local.get 0)))
    ...
    (func $__closure_wrapper_1 (;5;) (type 19) (param structref i32) (result i32)
      (local (ref null 7))
      (local.set 2
        (ref.cast (ref 7)
          (local.get 0)))
