(component
  ...
  (core module $main-mod (;1;)
    ...
    (type (;2;) (func))
    (type (;3;) (func (param structref i32) (result i32)))
    ...
    (func $__closure_wrapper_0 (;3;) (type 3) (param structref i32) (result i32)
      (unreachable)
      (unreachable)
    )
    (func $__closure_wrapper_1 (;4;) (type 3) (param structref i32) (result i32)
      (unreachable)
      (unreachable)
    )
  )
