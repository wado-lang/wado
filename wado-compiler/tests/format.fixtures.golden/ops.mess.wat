(component
  ...
  (core module $main-mod (;1;)
    (rec
      ...
      (type (;9;) (sub (struct (field (mut (ref 6))) (field (mut i32)))))
      (type (;10;) (sub (struct (field (mut (ref 7))) (field (mut i32)))))
      (type (;11;) (sub (struct (field (mut (ref 8))) (field (mut i32)))))
    )
    (type (;12;) (func (param i32 i32 i32 i32) (result i32)))
    (type (;13;) (func (param i32)))
    (type (;14;) (func))
    (import "mem" "realloc" (func (;0;) (type 12)))
    (import "wasi" "task-return" (func (;1;) (type 13)))
    (import "mem" "memory" (memory (;0;) 1))
    (export "run" (func $__cm_export__run))
    (func $__cm_export__run (;2;) (type 14)
      (call 1
        (i32.const 0))
    )
  )
