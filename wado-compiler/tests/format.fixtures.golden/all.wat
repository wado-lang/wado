(component
  ...
  (core module $main-mod (;1;)
    ...
    (type (;4;) (func))
    (type (;5;) (func))
    (type (;6;) (func (param structref i32) (result i32)))
    (type (;7;) (func (param structref i32) (result i32)))
    (type (;8;) (func (param structref i32 i32) (result i32)))
    (type (;9;) (func (param structref i32) (result i32)))
    (type (;10;) (func (param structref)))
    (type (;11;) (func (param structref (ref 1)) (result (ref 0) i32)))
    (import "mem" "realloc" (func (;0;) (type 2)))
    (import "wasi" "task-return" (func (;1;) (type 3)))
    (import "mem" "memory" (memory (;0;) 1))
    (export "run" (func $__cm_export__run))
    (func $run (;2;) (type 4))
    (func $__cm_export__run (;3;) (type 5)
      (call 1
        (i32.const 0))
    )
    ...
    (func $__closure_wrapper_2 (;6;) (type 7) (param structref i32) (result i32)
      (unreachable)
      (unreachable)
    )
    (func $__closure_wrapper_3 (;7;) (type 8) (param structref i32 i32) (result i32)
      (unreachable)
      (unreachable)
    )
    (func $__closure_wrapper_4 (;8;) (type 9) (param structref i32) (result i32)
      (unreachable)
      (unreachable)
    )
    (func $__closure_wrapper_5 (;9;) (type 7) (param structref i32) (result i32)
      (unreachable)
      (unreachable)
    )
    (func $__closure_wrapper_6 (;10;) (type 7) (param structref i32) (result i32)
      (unreachable)
      (unreachable)
    )
    (func $__closure_wrapper_7 (;11;) (type 11) (param structref (ref 1)) (result (ref 0) i32)
      (unreachable)
      (unreachable)
    )
    (func $__closure_wrapper_8 (;12;) (type 7) (param structref i32) (result i32)
      (unreachable)
      (unreachable)
    )
    (func $__closure_wrapper_9 (;13;) (type 10) (param structref)
      (unreachable)
    )
  )
