(component
  ...
  (core module $main-mod (;1;)
    ...
    (type (;7;) (func (param structref i32 i32) (result i32)))
    (type (;8;) (func (param structref i32) (result i32)))
    (type (;9;) (func (param structref)))
    (type (;10;) (func (param structref (ref 1)) (result (ref 0) i32)))
    ...
    (func $__closure_wrapper_1 (;5;) (type 7) (param structref i32 i32) (result i32)
      (unreachable)
      (unreachable)
    )
    (func $__closure_wrapper_2 (;6;) (type 8) (param structref i32) (result i32)
      (unreachable)
      (unreachable)
    )
    (func $__closure_wrapper_3 (;7;) (type 6) (param structref i32) (result i32)
      (unreachable)
      (unreachable)
    )
    (func $__closure_wrapper_4 (;8;) (type 6) (param structref i32) (result i32)
      (unreachable)
      (unreachable)
    )
    (func $__closure_wrapper_5 (;9;) (type 10) (param structref (ref 1)) (result (ref 0) i32)
      (unreachable)
      (unreachable)
    )
    (func $__closure_wrapper_6 (;10;) (type 6) (param structref i32) (result i32)
      (unreachable)
      (unreachable)
    )
    (func $__closure_wrapper_7 (;11;) (type 9) (param structref)
      (unreachable)
    )
  )
