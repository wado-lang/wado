(component
  ...
  (core module $main-mod (;1;)
    (rec
      ...
      (type (;19;) (func (param structref (ref null 2)) (result (ref null 2))))
    ...
    (type (;25;) (func))
    (type (;26;) (func))
    (type (;27;) (func (param structref (ref null 2)) (result (ref 1) i32)))
    ...
    (func $__closure_wrapper_5 (;9;) (type 27) (param structref (ref null 2)) (result (ref 1) i32)
      (local (ref null 5))
      (local.set 2
        (ref.cast (ref null 5)
          (local.get 0)))
