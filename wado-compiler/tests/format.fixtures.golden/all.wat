(component
  ...
  (core module $main-mod (;1;)
    ...
    (func $wado-compiler/tests/format.fixtures/all.dirty.wado/__cm_export__run (;2;) (type 2)
      (call $wado-compiler/tests/format.fixtures/all.dirty.wado/__initialize_modules)
      (call $wado-compiler/tests/format.fixtures/all.dirty.wado/__initialize_modules)
      (call 1
        (i32.const 0))
    )
    (func $wado-compiler/tests/format.fixtures/all.dirty.wado/__initialize_modules (;3;) (type 3)
      (if ;; label = @1
        (global.get 0)
        (then
          (return)))
