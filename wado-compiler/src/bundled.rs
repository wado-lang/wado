...
pub mod float_to_string {
    /// Function name for f64 to buffer conversion (shortest display)
    pub const F64_TO_BUFFER: &str = "f64_to_buffer";

    /// Function name for f32 to buffer conversion (shortest display)
    pub const F32_TO_BUFFER: &str = "f32_to_buffer";

    /// Function name for f64 to buffer with fixed-point precision
    pub const F64_TO_BUFFER_FIXED: &str = "f64_to_buffer_fixed";

    /// Function name for f32 to buffer with fixed-point precision
