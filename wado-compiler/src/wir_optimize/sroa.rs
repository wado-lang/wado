//! Scalar Replacement of Aggregates (SROA) passes for WIR.
//!
//! - **Multi-value return SROA**: rewrites struct-returning functions to use Wasm multi-value.
//! - **Single-field parameter SROA**: rewrites `ref null S` params to scalar values.
...
use super::collect_pinned_func_ids;
