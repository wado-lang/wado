...
/// The ICU4X character-property component, in text so it reads as source
/// rather than as an opaque blob. See `wado-bundled-icu/`.
pub const CORE_ICU_WAT: &[u8] = include_bytes!("../lib/core/icu.wat");

/// Every bundled wasm asset, keyed by the path the loader assigns to
/// [`ModuleSource::Wasm`](crate::module_source::ModuleSource::Wasm).
pub const ALL_CORE_WASM_ASSETS: &[(&str, &[u8])] = &[
    ("core:libm.wat", CORE_LIBM_WAT),
    ("core:icu.wat", CORE_ICU_WAT),
];
