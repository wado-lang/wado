...
use crate::tir::{
    ...
    TirFunction, TirLocal, TirParam, TirStmt, TirStmtKind, TirTemplatePart, TypeId, TypeTable,
};
...
use types::{
    binary_add, binary_ne, canonical_wasi_package, cm_param_align, cm_param_size,
    cm_param_store_plan, cm_val_type_to_type_id, cm_zero, compute_export_flat_param_types,
    compute_export_flat_return_types, export_needs_param_lifting, field_access, find_struct_decl,
    find_variant_decl, flat_types_from_type_id, flatten_export_type, is_gc_passthrough_param,
    is_unit_type, is_wasm_flat_type, kebab_to_pascal, module_source_for_cm_interface,
    needs_flat_result_lifting, type_id_to_ast_type, variant_payload, variant_tag, variant_test,
};
