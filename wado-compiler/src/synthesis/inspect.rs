...
///
/// Called by `synthesize_post_monomorphize` after template expansion.
...
///
/// Called by `synthesize_post_monomorphize` after template expansion and
/// marker replacement have registered all needed types.
...
fn synth_array(
    ...
    // This avoids needing the monomorphized Array<T>::len function, which may not exist
    // post-monomorphize if it was never referenced from user code.
