...
impl<'a> WirEmitter<'a> {
    ...
    fn emit_instr(&mut self, f: &mut Function, instr: &WirInstr) {
        match instr {
            ...
            WirInstr::I32Rotl(l, r) => self.emit_binary(f, l, r, Instruction::I32Rotl),
            WirInstr::I32Rotr(l, r) => self.emit_binary(f, l, r, Instruction::I32Rotr),
            ...
            WirInstr::I64Rotl(l, r) => self.emit_binary(f, l, r, Instruction::I64Rotl),
            WirInstr::I64Rotr(l, r) => self.emit_binary(f, l, r, Instruction::I64Rotr),
            ...
            WirInstr::ColdPath => {}
            // The barrier ends here; what the engine folds downstream is its own.
