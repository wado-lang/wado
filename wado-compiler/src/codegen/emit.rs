...
impl<'a> WirEmitter<'a> {
    ...
    fn emit_instr(&mut self, f: &mut Function, instr: &WirInstr) {
        match instr {
            ...
            WirInstr::I8x16NarrowI16x8S(l, r) => self.emit_binary(f, l, r, Instruction::I8x16NarrowI16x8S),
            WirInstr::I8x16NarrowI16x8U(l, r) => self.emit_binary(f, l, r, Instruction::I8x16NarrowI16x8U),
            ...
            WirInstr::I16x8NarrowI32x4S(l, r) => self.emit_binary(f, l, r, Instruction::I16x8NarrowI32x4S),
            WirInstr::I16x8NarrowI32x4U(l, r) => self.emit_binary(f, l, r, Instruction::I16x8NarrowI32x4U),
            WirInstr::I16x8ExtendLowI8x16S(a) => self.emit_unary(f, a, Instruction::I16x8ExtendLowI8x16S),
            WirInstr::I16x8ExtendHighI8x16S(a) => self.emit_unary(f, a, Instruction::I16x8ExtendHighI8x16S),
            WirInstr::I16x8ExtendLowI8x16U(a) => self.emit_unary(f, a, Instruction::I16x8ExtendLowI8x16U),
            WirInstr::I16x8ExtendHighI8x16U(a) => self.emit_unary(f, a, Instruction::I16x8ExtendHighI8x16U),
            WirInstr::I16x8ExtMulLowI8x16S(l, r) => self.emit_binary(f, l, r, Instruction::I16x8ExtMulLowI8x16S),
            WirInstr::I16x8ExtMulHighI8x16S(l, r) => self.emit_binary(f, l, r, Instruction::I16x8ExtMulHighI8x16S),
            WirInstr::I16x8ExtMulLowI8x16U(l, r) => self.emit_binary(f, l, r, Instruction::I16x8ExtMulLowI8x16U),
            WirInstr::I16x8ExtMulHighI8x16U(l, r) => self.emit_binary(f, l, r, Instruction::I16x8ExtMulHighI8x16U),
            WirInstr::I16x8ExtAddPairwiseI8x16S(a) => self.emit_unary(f, a, Instruction::I16x8ExtAddPairwiseI8x16S),
            WirInstr::I16x8ExtAddPairwiseI8x16U(a) => self.emit_unary(f, a, Instruction::I16x8ExtAddPairwiseI8x16U),
            WirInstr::I16x8Q15MulrSatS(l, r) => self.emit_binary(f, l, r, Instruction::I16x8Q15MulrSatS),
            ...
            WirInstr::I32x4DotI16x8S(l, r) => self.emit_binary(f, l, r, Instruction::I32x4DotI16x8S),
            WirInstr::I32x4ExtendLowI16x8S(a) => self.emit_unary(f, a, Instruction::I32x4ExtendLowI16x8S),
            WirInstr::I32x4ExtendHighI16x8S(a) => self.emit_unary(f, a, Instruction::I32x4ExtendHighI16x8S),
            WirInstr::I32x4ExtendLowI16x8U(a) => self.emit_unary(f, a, Instruction::I32x4ExtendLowI16x8U),
            WirInstr::I32x4ExtendHighI16x8U(a) => self.emit_unary(f, a, Instruction::I32x4ExtendHighI16x8U),
            WirInstr::I32x4ExtMulLowI16x8S(l, r) => self.emit_binary(f, l, r, Instruction::I32x4ExtMulLowI16x8S),
            WirInstr::I32x4ExtMulHighI16x8S(l, r) => self.emit_binary(f, l, r, Instruction::I32x4ExtMulHighI16x8S),
            WirInstr::I32x4ExtMulLowI16x8U(l, r) => self.emit_binary(f, l, r, Instruction::I32x4ExtMulLowI16x8U),
            WirInstr::I32x4ExtMulHighI16x8U(l, r) => self.emit_binary(f, l, r, Instruction::I32x4ExtMulHighI16x8U),
            WirInstr::I32x4ExtAddPairwiseI16x8S(a) => self.emit_unary(f, a, Instruction::I32x4ExtAddPairwiseI16x8S),
            WirInstr::I32x4ExtAddPairwiseI16x8U(a) => self.emit_unary(f, a, Instruction::I32x4ExtAddPairwiseI16x8U),
            WirInstr::I32x4TruncSatF32x4S(a) => self.emit_unary(f, a, Instruction::I32x4TruncSatF32x4S),
            WirInstr::I32x4TruncSatF32x4U(a) => self.emit_unary(f, a, Instruction::I32x4TruncSatF32x4U),
            WirInstr::I32x4TruncSatF64x2SZero(a) => self.emit_unary(f, a, Instruction::I32x4TruncSatF64x2SZero),
            WirInstr::I32x4TruncSatF64x2UZero(a) => self.emit_unary(f, a, Instruction::I32x4TruncSatF64x2UZero),
            ...
            WirInstr::I64x2ExtendLowI32x4S(a) => self.emit_unary(f, a, Instruction::I64x2ExtendLowI32x4S),
            WirInstr::I64x2ExtendHighI32x4S(a) => self.emit_unary(f, a, Instruction::I64x2ExtendHighI32x4S),
            WirInstr::I64x2ExtendLowI32x4U(a) => self.emit_unary(f, a, Instruction::I64x2ExtendLowI32x4U),
            WirInstr::I64x2ExtendHighI32x4U(a) => self.emit_unary(f, a, Instruction::I64x2ExtendHighI32x4U),
            WirInstr::I64x2ExtMulLowI32x4S(l, r) => self.emit_binary(f, l, r, Instruction::I64x2ExtMulLowI32x4S),
            WirInstr::I64x2ExtMulHighI32x4S(l, r) => self.emit_binary(f, l, r, Instruction::I64x2ExtMulHighI32x4S),
            WirInstr::I64x2ExtMulLowI32x4U(l, r) => self.emit_binary(f, l, r, Instruction::I64x2ExtMulLowI32x4U),
            WirInstr::I64x2ExtMulHighI32x4U(l, r) => self.emit_binary(f, l, r, Instruction::I64x2ExtMulHighI32x4U),
            ...
            WirInstr::F32x4ConvertI32x4S(a) => self.emit_unary(f, a, Instruction::F32x4ConvertI32x4S),
            WirInstr::F32x4ConvertI32x4U(a) => self.emit_unary(f, a, Instruction::F32x4ConvertI32x4U),
            WirInstr::F32x4DemoteF64x2Zero(a) => self.emit_unary(f, a, Instruction::F32x4DemoteF64x2Zero),
            ...
            WirInstr::F64x2ConvertLowI32x4S(a) => self.emit_unary(f, a, Instruction::F64x2ConvertLowI32x4S),
            WirInstr::F64x2ConvertLowI32x4U(a) => self.emit_unary(f, a, Instruction::F64x2ConvertLowI32x4U),
            WirInstr::F64x2PromoteLowF32x4(a) => self.emit_unary(f, a, Instruction::F64x2PromoteLowF32x4),
