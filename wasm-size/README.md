...
`wado` rows have moved. Wado was remeasured on 2026-09-11.
...
| -------- | -----------: | -------------------------------------- |
| wado     |       18,919 | stdin + gzip decompress (core:zlib)    |
...
| Language | Size (bytes) | Notes                                       |
| -------- | -----------: | ------------------------------------------- |
| wado     |      285,903 | Gale-generated highlighter from `SQLite.g4` |
