...
Measured 2026-08-16 with rustc 1.97.1, Zig 0.16.0, Moonbit 0.1.20260807, and
...
| -------- | -----------: | -------------------------------------- |
| wado     |       16,637 | stdin + gzip decompress (core:zlib)    |
...
| Language | Size (bytes) | Notes                                       |
| -------- | -----------: | ------------------------------------------- |
| wado     |      283,799 | Gale-generated highlighter from `SQLite.g4` |
