...
`wado` rows have moved. Wado was remeasured on 2026-09-12.
...
| -------- | -----------: | -------------------------------------- |
| wado     |       18,901 | stdin + gzip decompress (core:zlib)    |
...
| Language | Size (bytes) | Notes                                       |
| -------- | -----------: | ------------------------------------------- |
| wado     |      285,330 | Gale-generated highlighter from `SQLite.g4` |
